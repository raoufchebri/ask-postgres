...
export default async (req: NextApiRequest, res: NextApiResponse) => {
  ...
  // res.status(200).json({ res: queryIntent });
  ...
  console.log('queryIntent', queryIntent);
  ...
  const commandRes = await commandIntent.json();
...
export async function createStream(params: OpenAICompletionParams) {
